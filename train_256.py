...
from utils.config_256 import create_config
from utils.common_config import get_criterion, get_model, get_train_dataset, get_train_dataloader, \
...
def main():
    ...
    for epoch in range(start_epoch, p['epochs']):
        ...
        if epoch <= 500:
            print('Train pretext...')
            gcc_train(train_dataloader, model, criterion1, None, optimizer,
