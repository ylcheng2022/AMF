...
def create_config(config_file_env, config_file_exp):
    ...
    cfg['end2end_checkpoint'] = os.path.join(end2end_dir, 'model4.pth.tar')
    cfg['end2end_model'] = os.path.join(end2end_dir, 'model4.pth.tar')
    ...
    cfg['log_output_file'] = os.path.join(end2end_dir, 'log_512.txt')
