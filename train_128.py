...
from utils.config_128 import create_config
from utils.common_config import get_criterion, get_model, get_train_dataset, get_train_transformations, \
    get_val_transformations, get_optimizer, \
    adjust_learning_rate, get_train_dataloader_coil20
...
def main():
    ...
    train_dataloader = get_train_dataloader_coil20(p, train_dataset)

    print('Dataset contains {}/{} train/val samples'.format(len(train_dataset), len(train_dataset)))
